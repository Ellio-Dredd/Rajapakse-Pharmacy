...
export function AppointmentBookingPage({ doctorName = 'Dr. Michael Chen' }: AppointmentBookingPageProps) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Validate form
      if (!date || !selectedTime || !formData.firstName || !formData.email) {
        toast.error('Please fill in all required fields and select date/time');
        return;
      }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" placeholder="john.doe@example.com" onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="age" type="number" placeholder="25" onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
